...
Ca	write(NCH,'(A)')'      MU(J)=YWB(j)/(GP2*BTOR)'
	...
	write(NCH,'(A)')'      print *, 1, UPL(NA)'
	write(NCH,'(A)')'      UPL(NA1)=ARRNA1(UPL(NA),HROA/HRO)'
...
C	write(NCH,'(A)')'      UPL(J)=YWD(J)'
	...
	write(NCH,'(A)')'      enddo'
	write(NCH,'(A)')'      print *, 2, UPL(NA-3:NA)'	
	write(NCH,'(A)')'      UPL(NA1)=ARRNA1(UPL(NA),HROA/HRO)'
...
C	write(NCH,'(A)')'      MU(NA1)=MU(NA)*NA/(NA-0.5+YHC)'
	write(NCH,'(A)')'      print *, 3, MU(NA-3:NA)'
	write(NCH,'(A)')'      MU(NA1)=ARRNA1(MU(NA),YHC)'
		endif
C----------------------------------------------------------------------|
...
C	write(NCH,'(A)')'      CU(J)	=YJ*CU(J)+CV(J)'
	...
	write(NCH,'(A)')'      print *, 4, ULON(NA-3:NA)'	
	write(NCH,'(A)')'      ULON(NA1) = ARRNA1(ULON(NA),HROA/HRO)'
C	write(NCH,'(A)')'      ULON(NA1) = ULON(NA)'
	write(NCH,'(A)')
