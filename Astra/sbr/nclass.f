...
Corig                ymu_s(k,l,i)=(ymupos(k,l,i)**3*ymupps(k,l,i)
Corig     #                       +ymubs(k,l,i)**3*ymubps(k,l,i))
Corig     #                       /(ymupos(k,l,i)**3+ymubs(k,l,i)**3)
C The 3 above line have been replaced to avoid division by zero
C     when ymupos^3 and ymubs^3 become very small
C     G.Pereverzev 16-10-2008
