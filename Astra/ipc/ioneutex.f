...
C----------------------------------------------------------------------|
	call	to_neutex(JSBP,NNCX,SNNBM)
	end
C======================================================================|
	subroutine OTNEUTEX(JSBP,JSBR)
C----------------------------------------------------------------------|
C Call of this subroutine is created by the Astra compiler
C Parameter JSBP is the ordinal number of the (&:) request in a model
...
C----------------------------------------------------------------------|
	call	ot_neutex(JSBP,NN,TN,ALBPL,CPTSBR(JSBR))
C	call	ot_neutex(JSBP,CAR1,CAR2,ALBPL,CPTSBR(JSBR))
	end
C======================================================================|
