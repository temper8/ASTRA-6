	 subroutine cntrlr_iter(kgrid,voltpf)
     ...
     &                    cam_tok(ntimp)
       ...
       common /com_cpar/ R_ax,Z_ax,platok,Dgap,currpf,vz_cc,ngap,n_pf
       dimension voltpf(*)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	 subroutine get_cpar(R_ax,Z_ax,tokpl,gap,cur_pf,vz,n_gap,n_pfc)
       include 'double.inc'
       include 'parevo.inc'
       include 'dimcp.inc'
       common /com_conpar/ Rc_ref,Zc_ref,cur_ref,gap_ref,pf_ref
       common /com_cpar/ R_a,Z_a,platok,Dgap,currpf,vz_cc,ngap,n_pf
       dimension currpf(npfc0),cur_pf(*)
       dimension gap(*),Dgap(ngapp)
