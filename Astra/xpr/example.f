C======================================================================|
C ./example /home/grp/TAstra/.tsk/Intel/neut.exe 14638 772309392 1
C----------------------------------------------------------------------|
C Make as
C $> cc -c xpr/template.c -o xpr/template.o
C $> cc -c xpr/ipc.c -o xpr/ipc.o
C $> f95f xpr/example.f xpr/template.o xpr/ipc.o -o xpr/example
C----------------------------------------------------------------------|
	program   main
	implicit  none
